...
// point バッククォートを使用すると${}で変数を入れることができる
...
<template>
    <div v-show="isShow" class="modal" id="modal-1" aria-hidden="true" style="display: none">
                                ...
                                <tr v-for="customer in customers.value.data" :key="customers.id">
                                    <td class="border-b-2 border-gray-200 px-4 py-3">
                                        <button
                                            ...
                                            type="button"
                                            class="border-gray-200 px-4 py-3"
                                        >
                                            {{ customer.id }}
                                        </button>
                                    </td>
    ...
    <button
        ...
        class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg"
    >
        検索する
    </button>
</template>
